...
@Getter
public class StrongholdCaptureEnterEvent extends RegionEnteredEvent {

    private final Stronghold stronghold;

    public StrongholdCaptureEnterEvent(ProtectedRegion region, CorePlayer player, MovementWay movement, Stronghold stronghold) {
