...
public class WeaponTypeDataService {
    ...
    @Cacheable(cacheNames = "weapon_type_data", key = "#weaponType")
    ...
    @CachePut(cacheNames = "weapon_type_data", key = "#result.weaponType")
    public WeaponTypeData update(WeaponTypeData weaponTypeData){
        return this.weaponTypeDataRepository.save(weaponTypeData);
    }

    @CacheEvict(cacheNames = "weapon_type_data", key = "#weaponTypeData.weaponType")
